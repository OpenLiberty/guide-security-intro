...
You'll learn how to secure a web application by performing authentication and authorization using Java EE Security. 
...
Java EE Security provides capability to configure the basic authentication, form authentication or custom 
...
uses the `j_security_check` action, which is defined by Java EE and available by default.
...
The SecurityContext interface provides programmatic access to Java EE Security API. 
...
access information in the registry for authentication and authorization using API like Java EE Security API.
