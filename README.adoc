...
The password is encoded with Liberty's securityUtility command. Here, the application uses the xor encoding. There are two other supported encodings are well: hash and aes that can be used.
