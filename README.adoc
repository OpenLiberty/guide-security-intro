...
The `ProfileServlet` and `AdminServlet` simply display user information such as the name and role for the currently authenticated user.
...
In order to enable form authentication, create the `UserServlet` class in the `src/main/java/io/openliberty/guides/ui/ProfileServlet.java` file.
[source, java, indent=0]
----
include::finish/src/main/java/io/openliberty/guides/ui/ProfileServlet.java[tags=security;!copyright]
----
