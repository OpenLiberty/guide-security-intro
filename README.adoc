...
Form Authentication allows you to customize your login screen and error page. As you can see, loginPage is directed to "login.jsf" and errorPage is directed to "loginerror.jsf". If you would like to see the how those pages are designed they are in the /finish/src/main/webapp directory.
