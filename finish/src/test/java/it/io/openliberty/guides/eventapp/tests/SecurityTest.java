...
public class SecurityTest {
  ...
  public void testIncorrectAuthentication(){
    //Testing locally first
    JsonObject user = sendForm(loginForm, USERS_URL);
    // actualDataStored.put(user.getString(JSONFIELD_));
